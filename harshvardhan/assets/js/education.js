...
const timelinesection = [
  {
    heading: "Skn Sinhgad College Of Engineering, Lonavala",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"Bachelor of Engineering (B.E), Information Technology",
    description: "<li>Participated In SPANDAN 2019 Events</li><li>Participated In TECHTONIC Event</li><li>Kabaddi Player Of SKN-SITS Team</li>",
  },

  {
    heading: "Annasaheb Waghire College,Otur.",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"Senior Secondary (XII), Science",
    description: "<li>Year of completion: 2017 </li><li>Percentage: 57.85%</li>",
  },

  {
    heading: "Holy Cross High School,Kurla.",
    image: "./assets/images/education-page/timeline-1.svg",
    subheading:"Secondary (X) , (MAHARASHTRA STATE BOARD Board)",
    description: "<li>Year of completion: 2014.</li><li> Percentage: 63.60%</li>",
  },
];
